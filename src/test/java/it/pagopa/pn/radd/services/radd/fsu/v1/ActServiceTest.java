...
class ActServiceTest  {
    ...
    void testStartTransactionReturnErrorPnInvalidInputException(){
        ...
        StepVerifier.create(actService.startTransaction("id",  "cxId",CxTypeAuthFleet.PG, "RADD_UPLOADER", null, startTransactionRequest) )
                    .expectError(PnInvalidInputException.class).verify();
    }
    ...
    void testStartTransactionReturnErrorResponseStatusExceptionRaddStandardWithFileKey(){
        ...
        transactionData.setQrCode("qrcode");
        transactionData.setIun("iun");
        StepVerifier.create(actService.startTransaction("id",  "cxId",CxTypeAuthFleet.PG, "RADD", null, startTransactionRequest) )
                    .expectErrorMatches(throwable -> throwable instanceof PnRaddBadRequestException &&
    ...
    void testStartTransactionReturnError(){
        ...
        startTransactionRequest.setChecksum("checksum");
        startTransactionRequest.setVersionToken("versionToken");
        Mono<StartTransactionResponse> response = actService.startTransaction("test", "123", CxTypeAuthFleet.PG, "RADD_UPLOADER", null, startTransactionRequest);
        response.onErrorResume(PnInvalidInputException.class, exception -> {
        ...
        Mono<StartTransactionResponse> response2 = actService.startTransaction("test", "cxId",CxTypeAuthFleet.PG, "RADD_UPLOADER", null, startTransactionRequest);
        ...
        Mono<StartTransactionResponse> response3 = actService.startTransaction("test","cxId",CxTypeAuthFleet.PG, "RADD_UPLOADER", null, startTransactionRequest);
    ...
    void testStartTransactionReturnErrorBecauseAlreadyExistsQrCodeInCompletedAndPrintsAreLimitedTo1() {
        ...
        StartTransactionResponse response = actService.startTransaction("id","cxId",CxTypeAuthFleet.PF, "RADD_UPLOADER", null, startTransactionRequest).block();
