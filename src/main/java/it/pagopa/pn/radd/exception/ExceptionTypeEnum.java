...
public enum ExceptionTypeEnum {
    ...
    COVERAGE_DATE_INTERVAL_ERROR("COVERAGE_DATE_INTERVAL_ERROR","La data di fine validità non può essere precedente alla data di inizio validità o la data di inizio validità è mancante", 99),
    ...
    COVERAGE_ALREADY_EXISTS("COVERAGE_ALREADY_EXISTS", "La copertura inserita è già esistente", 99),
    RADD_REGISTRY_NOT_FOUND("RADD_REGISTRY_NOT_FOUND","Punto di ritiro SEND non trovato",99 ),
    COVERAGE_NOT_FOUND("COVERAGE_NOT_FOUND","La copertura non è stata trovata",99 ),
