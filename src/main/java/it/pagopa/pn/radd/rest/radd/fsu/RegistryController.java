...
public class RegistryController implements ImportApi {
    ...
    public Mono<ResponseEntity<RegistryUploadResponse>> uploadRegistryRequests(CxTypeAuthFleet xPagopaPnCxType, String xPagopaPnCxId, String uid, Mono<RegistryUploadRequest> registryUploadRequest, final ServerWebExchange exchange) {
        return handleUploadRegistryRequests(xPagopaPnCxId, uid, registryUploadRequest, exchange);
    }
    ...
    public Mono<ResponseEntity<RegistryUploadResponse>> uploadRegistryRequestsBo(CxTypeAuthFleet xPagopaPnCxType, String xPagopaPnCxId, String xPagopaPnUid, Mono<RegistryUploadRequest> registryUploadRequest, ServerWebExchange exchange) {
        return handleUploadRegistryRequests(xPagopaPnCxId, xPagopaPnUid, registryUploadRequest, exchange);
    }

    private Mono<ResponseEntity<RegistryUploadResponse>> handleUploadRegistryRequests(String xPagopaPnCxId, String uid, Mono<RegistryUploadRequest> registryUploadRequest, final ServerWebExchange exchange) {
    ...
    public Mono<ResponseEntity<VerifyRequestResponse>> verifyRequest(CxTypeAuthFleet xPagopaPnCxType, String xPagopaPnCxId, String uid, String requestId, final ServerWebExchange exchange) {
        return handleVerifyRequest(xPagopaPnCxId, requestId, exchange);
    }
    ...
    private Mono<ResponseEntity<VerifyRequestResponse>> handleVerifyRequest(String xPagopaPnCxId, String requestId, final ServerWebExchange exchange) {
    ...
    public Mono<ResponseEntity<RequestResponse>> retrieveRequestItems(CxTypeAuthFleet xPagopaPnCxType, String xPagopaPnCxId, String uid, String requestId, Integer limit, String lastKey, final ServerWebExchange exchange) {
        return handleRetrieveRequestItems(xPagopaPnCxId, requestId, limit, lastKey, exchange);
    }
    ...
    private Mono<ResponseEntity<RequestResponse>> handleRetrieveRequestItems(String xPagopaPnCxId, String requestId, Integer limit, String lastKey, final ServerWebExchange exchange) {
